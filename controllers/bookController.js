...
exports.book_delete_get = function(req, res, next) {
    async.parallel({
        ...
        res.render('book_delete', {title: 'Delte Book', book: results.book, bookInstances: results.bookInstance});
    });
};
...
exports.book_delete_post = function(req, res, next) {
    async.parallel({
        ...
        if (results.bookInstance.length > 0) {
            ...
            Book.findByIdAndRemove(req.body.bookid, function deletBook(err) {
                if (err) {return next(err);}
                res.redirect('/catalog/books');
            });
        }
